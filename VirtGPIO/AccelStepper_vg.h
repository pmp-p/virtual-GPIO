...
public:
    ...
    void __init__(uint8_t interface, uint8_t pin1 = 4, uint8_t pin2 = 5, uint8_t pin3 = 6, uint8_t pin4 = 7, bool enable = true);
...
private:
    ...
    //void init_pins(uint8_t pin1, uint8_t pin2, uint8_t pin3, uint8_t pin4);
