...
//uint8_t pin1, uint8_t pin2, uint8_t pin3, uint8_t pin4, bool enable
void AccelStepper::__init__(uint8_t interface, uint8_t pin1, uint8_t pin2, uint8_t pin3, uint8_t pin4, bool enable)
{
    _interface = interface;
    _currentPos = 0;
    _targetPos = 0;
