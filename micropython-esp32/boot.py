...
import gc, machine, sys, time, builtins
...
builtins.protected = ['protected','excepthook','displayhook','i2ctx','USE_AUTORUN','_webrepl','issue']
...
def wlan_client(essid,password,ap=False):
    ...
    if not sys.platform.startswith('esp'):
        print('not on board')
